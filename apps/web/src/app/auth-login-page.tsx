...
import { TreePalm, Mail, Lock, Eye, EyeOff, Github, ArrowRight } from 'lucide-react'
      ...
      <div className="sticky top-0 z-40 backdrop-blur-sm bg-white/50 border-b border-primary-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <p className="text-sm text-primary-600">
            ...
            <Link href="/auth/signup" className="font-semibold text-forest-600 hover:text-forest-700">
              Sign up
            </Link>
          </p>
        </div>
      ...
      <div className="relative min-h-[calc(100vh-88px)] flex items-center justify-center px-4 py-20">
        <div className="w-full max-w-md animate-scale-in">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-primary-950 mb-3">Welcome Back</h1>
            <p className="text-lg text-primary-600">
              Connect your ancestral ties and continue building your legacy
            </p>
          </div>
          ...
          <Card className="backdrop-blur-sm bg-white/95 shadow-brand-lg border border-white/40 mb-6">
            ...
            <div className="relative mb-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-primary-600 font-medium">Or continue with email</span>
              </div>
            </div>
